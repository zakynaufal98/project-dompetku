...
import { Empty, PanelHeader, ProgressBar } from '../components/UI'
import { LineChart, BarChartHorizontal, PieChart as PieChartIcon } from 'lucide-react'
...
export default function Grafik() {
  ...
  return(
    <div className="animate-fade-up space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="bg-white border border-slate-200 rounded-[24px] p-6 md:p-8 shadow-sm">
        <PanelHeader title="Intensitas Pengeluaran Harian" />
