  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'modal-backdrop': 'modalBackdrop 0.22s ease-out both',
        'modal-pop': 'modalPop 0.26s cubic-bezier(0.16, 1, 0.3, 1) both',
        'sheet-up': 'sheetUp 0.3s cubic-bezier(0.16, 1, 0.3, 1) both',
        'soft-pop': 'softPop 0.22s cubic-bezier(0.16, 1, 0.3, 1) both',
      },
      keyframes: {
        ...
        modalBackdrop: { from: { opacity: 0 }, to: { opacity: 1 } },
        modalPop: {
